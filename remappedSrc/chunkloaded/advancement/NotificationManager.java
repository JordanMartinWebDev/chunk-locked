...
public class NotificationManager {
  ...
  public void notifyCreditsAvailable(ServerPlayer player, int availableCredits, int totalCompleted) {
    Component message = Component.translatable(
        ...
        Component.literal(String.valueOf(availableCredits)).styled(style -> style.withColor(0xFFD700)), // Gold
        Component.literal(String.valueOf(totalCompleted)).styled(style -> style.withColor(0xAAAAAA)) // Gray
    );
  ...
  private Component createCreditAwardMessage(String advancementName, int credits) {
    ...
    return Component.translatable(
        ...
        Component.literal(String.valueOf(credits)).styled(style -> style.withColor(0xFFD700)), // Gold
        Component.literal(creditText).styled(style -> style.withColor(0xFFD700)), // Gold
        Component.literal(advancementName).styled(style -> style.withColor(0xAAAAAA)) // Gray
    );
  }

...
class AdvancementCreditManagerTest {
    ...
    void testLoadConfig() {
        var config = new chunkloaded.config.AdvancementRewardConfig();
    ...
    void testLoadConfig_MultipleTimes() {
        var config1 = new chunkloaded.config.AdvancementRewardConfig();
        config1.setDefaultCredits(5);
        manager.loadConfig(config1);
        assertEquals(5, manager.getCreditAmount("minecraft:test"));

        var config2 = new chunkloaded.config.AdvancementRewardConfig();
        ...
        var config3 = new chunkloaded.config.AdvancementRewardConfig();

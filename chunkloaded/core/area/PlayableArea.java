...
public class PlayableArea {
  ...
  private final class_1923 centerChunk;
   ...
   */
  public PlayableArea(int areaId, @NotNull Set<class_1923> chunks) {
   ...
   */
  private class_1923 calculateCenter() {
    long sumX = 0;
    long sumZ = 0;
    ...
    return new class_1923(centerX, centerZ);
  }
   ...
   */
  public Set<class_1923> getChunks() {
    return chunks;
  }
   ...
   */
  public boolean contains(@NotNull class_1923 pos) {
   ...
   */
  public boolean isAdjacentTo(@NotNull class_1923 pos) {
    Objects.requireNonNull(pos, "ChunkPos cannot be null");
   ...
   */
  private boolean isAdjacent(@NotNull class_1923 pos1, @NotNull class_1923 pos2) {
    int dx = Math.abs(pos1.field_9181 - pos2.field_9181);
    int dz = Math.abs(pos1.field_9180 - pos2.field_9180);

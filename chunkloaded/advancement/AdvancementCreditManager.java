...
public class AdvancementCreditManager {
   ...
   */
  public void onAdvancementCompleted(class_3222 player, class_8779 advancement, String criterionName) {
    ...
    LOGGER.info("  Player: {}", player.method_5477().getString());
   ...
   * @return The player's progression data (never null)
   */
  public PlayerProgressionData getPlayerData(class_3222 player) {
    return getPlayerData(player.method_5667());
  }
